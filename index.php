    ...
    <div id="content">
        <div id="index_content">
            ...
            <form action="includes/createpost.php" method="POST">
                <input name="lvaCode" placeholder="Course Code">
                <input name="lvaName" placeholder="Course Name">
                <input name="professor" placeholder="Professor">
                <input type="number" step="0.5" name="ects" placeholder="Rating">
                <input name="description" placeholder="Comment">
                <br><br>
